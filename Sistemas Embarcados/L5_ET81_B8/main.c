...
void bokuNoPWM(void):           //inicializa o timer A1.1 com período de 99 contagens (período de 40kHz) e em modo de comparação RESET-SET no pino P2.0
void myGPIOwithInterrupt(void);              //Define as portas P2.1 e P1.1 como entrada e P2.4 e P2.5 como saídas para o controle da direção do motor.
void changePWM(void);
...
void bokuNoPWM(){
        ...
        initUpParam.timerPeriod = 99; //Define período do sinal PWM
